...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  saveSettings: (settings: { keybind?: string; fullscreenMode?: boolean; includeTax?: boolean; leagueId?: string; layoutStyle?: 1 | 2 }) => ipcRenderer.invoke('save-settings', settings),
